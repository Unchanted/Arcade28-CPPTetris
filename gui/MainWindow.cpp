...
void Tetris::gui::MainWindow::initWidgets(){
    ...
    m_messageBox->setText(QString("This application is written in C++ with Qt6 and OpenGL libraries.\n"
                                 "Have a look at the <a href=\"https://github.com/Unchanted/CPPTetris\">source code</a>.\n"));
